...
uniform float u_SwaySpeed; // {"material":"Sway Speed","default":0.75,"range":[0,2]}
uniform float u_SwayStrength; // {"material":"Sway Strength","default":0.025,"range":[0,1]}
...
void main() {
	...
	worldPos.x += sin(worldPos.z * 4.0 + g_Time * u_SwaySpeed) * u_SwayStrength;// * texSample2D(g_Texture0, v_TexCoord.xy).r;
